...
* 对表单应用程序重用您的专有UI组件。
* 使用Adobe Experience Manager Forms[的](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-65/content/forms/getting-started/introduction-aem-forms)强大功能。
